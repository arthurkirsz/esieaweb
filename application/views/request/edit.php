...
<div class="app-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-5" style="padding: 24px 40px;background-color: #fff;border-radius: .3125em;border-left: 1px solid #dedfe2;border-right: 1px solid #dedfe2;border-bottom: 1px solid #D0D1D5;box-shadow: 0 1px 0 0 #dedfe2;min-height: 455px;margin-right: 20px;">
            <form action="<?php echo URL; ?>request/update/<?php echo $request->request_id; ?>" method="POST" class="js-create-request">

                <input class="app-input searchfield-bottom input-radius js-input" placeholder="Type de la demande" name="type" value="<?php echo $request->request_type; ?>">


                <input class="app-input searchfield-top js-input" type="text" name="startdate" value="<?php echo $request->startdate; ?>" placeholder="Date de début" autocomplete="off">
                <input class="val-startdate" type="hidden" name="startdate" value="">
                <input class="app-input searchfield-bottom js-input" type="text" name="enddate" value="<?php echo $request->enddate; ?>" placeholder="Date de fin" autocomplete="off">
...
<script type="text/javascript" charset="utf-8">
    jQuery(document).ready(function($) {
        ...
        moment.locale("fr");
        // $('.app-input[name="startdate"]').val(moment(parseInt($(this).val())).format("LLLL"));
        // $('.app-input[name="enddate"]').val(moment($(this).val()).format("LLLL"));
