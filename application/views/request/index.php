...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-9">
            ...
            <h1>Demandes en cours de traitement</h1>
        </div>
        <div class="col-lg-3">
            <a href="<?php echo URL; ?>request/add" class="btn btn-primary" style="border-radius:20px; margin: 50px auto 0;">Faire une demande</a>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                    ...
                    foreach ($this->requests as $request) {
                        echo '<div class="request ' . ( ($i==0) ? 'request-top' : 'request-center' ). '">';
                            ...
                            echo '<div style="float:right;margin:10px;">
                                    <a href="'.URL.'request/edit/'.$request->request_id.'">Modifier</a>&nbsp;&nbsp;|&nbsp;
                                    <a href="'.URL.'request/delete/'.$request->request_id.'">Supprimer</a>
                                  </div>';
    ...
    <a href="<?php echo URL; ?>request/archive">Requetes terminées</a>
</div>
